...
export default function ProjectControl() {
  ...
  const fetchProjects = async () => {
    setLoading(true);
    try {
      // Conecta com a REST API homologada
      ...
      // Normalização dos campos numéricos vindo do MongoDB
  ...
  const exportCsv = () => {
    const headers = [
      ...
      "Inicio P1", "Fim P1", "Status P1", "Inicio P2", "Fim P2", "Status P2", "Inicio P3", "Fim P3", "Status P3"
    ];
