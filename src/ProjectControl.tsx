...
export default function ProjectControl() {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      // Normalização dos dados conforme os campos vistos no Compass
  ...
  // Estilos com cor de fonte forçada para preto (#111827)
  ...
  return (
    <div style={S.page}>
      ...
      {/* Layout de Filtros conforme o original */}
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              ...
              <th style={S.th}>Dias Fase</th>
              <th style={S.th}>Dias Totais</th>
      ...
      {isModalOpen && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ background: "white", padding: 25, borderRadius: 12, width: 400, color: "#111827" }}>
            ...
            <textarea 
              style={{ width: "100%", height: 100, marginBottom: 15, padding: 10, border: "1px solid #ccc", color: "#111827" }} 
              value={newReason} 
